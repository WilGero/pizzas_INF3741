                ...
                <div class="card-body">
                    <form method="PUT" action="{{ route('products.update', $product->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input id="amount" type="text" class="col form-control @error('amount') is-invalid @enderror" name="{{ $supplie->name }}" value="{{ $supplie->pivot->amount }}" autocomplete="amount" autofocus required>
                                @error('amount')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
